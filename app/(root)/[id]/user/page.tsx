...
import { PostsUsersCard } from '@/app/components/postCard';
...
const follower = await ListAllthefollower(user.email)
    return (
      <main className="w-full h-full flex-col items-center hidden md:flex md:ml-3 xl:ml-[200px] bg-gradient-to-r from-gray-200 via-blue-500 to-slate-800 rounded-md px-4 py-6">
