...
const follower = await ListAllthefollower(user.email)
    return (
      <main className=" lg:w-full h-full flex flex-col items-center justify-center  md:flex md:ml-3 xl:ml[-240px] bg-gradient-to-r from-gray-200 via-blue-500 to-slate-800 rounded-md px-4 py-6">
