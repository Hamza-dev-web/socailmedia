...
<main className="hidden sm:w-full md:flex  lg:flex flex-col items-center w-full max-w-[1200px] h-full bg-gradient-to-r from-gray-400 via-blue-500 to-gray-200 rounded-md shadow-xl p-8 mx-auto">
 ...
 /*
 <main className="sm:w-screen hidden  md:ml-3 xl:ml-[200px] md:flex sm:ml-0 sm:flex  xl:w-[1200px]    lg:flex  flex-col  rounded-md   items-center   w-[1200px]   shadow-xl  h-full  bg-gradient-to-r from-gray-400 via-blue to-gray-200  ">
   <h1 className=" mb-20 text-black text-[50px] font-extrabold"> Welcome to the Create  Posts Page 👋</h1>
    <Form {...form} >
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8 sm:mt-8  gap-10   bg-gradient-to-r from-slate-800 via-blue to-gray-200 w-[600px] h-[600px] rounded-lg p-5  items-center">
        <FormField
          control={form.control}
          name="title"
          render={({ field }) => (
